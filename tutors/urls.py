...
urlpatterns = [
    ...
    path('edit_tutor/<int:user_id>', views.edit_tutor, name='edit_tutor'),
    path('image_update/<int:tutor_id>', views.image_update, name='image_update'),
    path('payment_setup/', views.payment_setup, name='payment_setup')
]
